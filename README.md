...
Fixes Tab key getting stuck in pressed state when using Tab+Alt, Shift+Tab, Tab+Shift key combinations. As a result fixes SKSE Menu Framework and Open Animation Replacer bug where Tab key gets stuck and IMGUI controls change focus until you press Tab again:

![Error showcase](./docs/repro.gif)

More information can be found at [Nexus Mods mod page](https://www.nexusmods.com/skyrimspecialedition/mods/160062).
